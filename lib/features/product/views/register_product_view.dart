  ...
  Widget build(BuildContext context) {
    return Consumer<RegisterProductViewModel>(
      builder: (context, viewModel, child) {
        return Scaffold(
          appBar: AppBar(
            title: const Text('Registrar Novo Produto'),
            centerTitle: true,
          ),
              ...
              children: [
                ...
                Autocomplete<String>(
                  optionsBuilder: (TextEditingValue textEditingValue) {
                    ...
                    return viewModel.productNameSuggestions.where((String option) {
                  ...
                  fieldViewBuilder: (
                    ...
                    Future.microtask(() => fieldTextEditingController.text = viewModel.nameController.text);

                    return TextField(
                      controller: fieldTextEditingController, // Usar o controller do Autocomplete
                      focusNode: fieldFocusNode,
                      decoration: const InputDecoration(hintText: 'Ex: Parafuso Sextavado M8'),
                ...
                const Text('Local de Armazenagem (Opcional)', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                Autocomplete<String>(
                  optionsBuilder: (TextEditingValue textEditingValue) {
                    if (textEditingValue.text.isEmpty) {
                  ...
                  fieldViewBuilder: (
                    ...
                    Future.microtask(() => fieldTextEditingController.text = viewModel.locationController.text);
                    return TextField(
                      controller: fieldTextEditingController,
                      focusNode: fieldFocusNode,
                      decoration: const InputDecoration(hintText: 'Ex: Prateleira A-02, Caixa 15'),
                      onChanged: (String value) {
                ...
                const Text('Armazenado por (Opcional)', style: TextStyle(fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                Autocomplete<String>(
                  optionsBuilder: (TextEditingValue textEditingValue) {
                    if (textEditingValue.text.isEmpty) {
                  ...
                  fieldViewBuilder: (
                    ...
                    Future.microtask(() => fieldTextEditingController.text = viewModel.storedByController.text);
                    return TextField(
                      controller: fieldTextEditingController,
                      focusNode: fieldFocusNode,
                      decoration: const InputDecoration(hintText: 'Ex: João da Silva'),
                      onChanged: (String value) {
